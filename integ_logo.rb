...
conf = { 
  'je' => { 'conffile' => '/home/grego/WORK/JOBENFANCE/je.dolibarr.git/htdocs/conf/conf.php' },
  'jd' => { 'conffile' => '/home/grego/WORK/JOBENFANCE/jd.dolibarr.git/htdocs/conf/conf.php' },
  'logos_dir' => '/home/grego/WORK/JOBENFANCE/EXTRACTION/JE/logos',
  'logo_je' => '/home/grego/WORK/JOBENFANCE/EXTRACTION/JE/images/logo_jobenfance_formation.gif',
  'logo_jd' => '/home/grego/WORK/JOBENFANCE/EXTRACTION/JE/images/logo_jobdependance_formation.gif'
}
...
Formation.where(:dest => 'je').map { |f| f.id_doli }.each { |tiers_id|
